...
export function EmptyState({
  ...
  return (
    <section className={cn('rounded-[2rem] border border-black/8 bg-white p-8 text-center shadow-[0_18px_60px_rgba(15,23,42,0.06)]', className)}>
      <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-[#f7f5ef] text-[#005c6b]">
      ...
      <Link href={actionHref} className="mt-6 inline-flex items-center gap-2 rounded-full bg-[#005c6b] px-5 py-3 text-sm font-black text-white transition hover:-translate-y-0.5">
        {actionLabel}
